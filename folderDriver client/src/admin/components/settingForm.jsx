    ...
    <form onSubmit={handlePasswordSubmit} className="p-5">
      ...
      <div className="mt-5 flex justify-end">
        <button
          ...
          className="rounded-lg bg-slate-800 px-4 py-2 text-xs font-medium text-white transition hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-blue-600 dark:hover:bg-blue-700"
        >
          {changingPassword
            ? hasPassword
              ? "Changing..."
