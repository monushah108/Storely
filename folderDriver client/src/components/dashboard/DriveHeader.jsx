...
export default function DriveHeader({
  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 sm:h-16 w-full shrink-0 items-center justify-between border-b border-gray-200 bg-white px-2.5 sm:px-4 md:px-6">
      ...
      {mobileSearchOpen ? (
        <div className="flex w-full items-center gap-2 sm:hidden animate-in fade-in duration-150">
          <button
            ...
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-gray-600 transition hover:bg-gray-100 active:scale-95"
          >
          ...
          <div className="relative flex flex-1 items-center">
            <input
              ...
              className="w-full rounded-full border border-gray-200 bg-[#edf2fc] py-2 pl-3.5 pr-9 text-sm text-gray-800 placeholder:text-gray-500 focus:border-blue-400 focus:bg-white focus:outline-none"
            />
            {searchQuery && (
              <button
                type="button"
                onClick={() => setSearchQuery("")}
                className="absolute right-2.5 flex h-6 w-6 items-center justify-center rounded-full text-gray-400 hover:text-gray-700"
        ...
        <>
          ...
          <div className="flex items-center gap-1.5 sm:gap-4 md:w-64">
            <button
              ...
              className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-full text-gray-600 transition hover:bg-gray-100 lg:hidden"
            >
            ...
            >
              ...
              <div className="flex items-baseline gap-1">
                <span className="text-lg sm:text-xl font-bold tracking-tight text-gray-800">
                  Storely
                </span>
                <span className="hidden text-xs sm:text-sm font-medium text-gray-500 sm:inline">
                  Drive
                </span>
              </div>
            </Link>
