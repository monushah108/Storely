  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="w-full max-w-sm rounded-2xl border border-gray-200 bg-white p-6 shadow-2xl animate-in fade-in zoom-in-95"
      >
        ...
        <div className="mt-4">
          <input
            ...
            className="w-full rounded-lg border border-blue-600 px-3.5 py-2.5 text-sm text-gray-800 outline-none ring-2 ring-blue-100"
          />
        </div>
        ...
        <div className="mt-6 flex justify-end gap-2">
          <button
            type="button"
            onClick={onClose}
            className="rounded-full px-4 py-2 text-xs font-semibold text-gray-600 transition hover:bg-gray-100 hover:text-gray-900"
          >
            Cancel
          </button>
